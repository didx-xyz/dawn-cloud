id: file://<WORKSPACE>/src/xyz/didx/Endpoints.scala:[538..541) in Input.VirtualFile("file://<WORKSPACE>/src/xyz/didx/Endpoints.scala", "package xyz.didx
...
file://<WORKSPACE>/src/xyz/didx/Endpoints.scala:23: error: expected identifier; obtained val
    val didKeyEndpoint: PublicEndpoint[String, Unit, DIDDoc, Any] = 
    ^
#### Short summary: 
